                        ...
                        {visibleDays.map(d => {
                            ...
                            return (
                                <th key={d.getDate()}
                                    ...
                                    className={`p-2 border-b border-r border-gray-200 text-center w-[45px] cursor-pointer hover:bg-blue-50 transition-colors ${isSelected ? 'bg-blue-100' : isToday ? 'bg-yellow-50' : ''} ${isSelected ? 'table-cell' : 'hidden md:table-cell'}`}>
